...
### `Application`
*bases: LomObject — This class represents the Live application.*
...
- `show_message((Application)arg1, (Text)text [, (int)buttons=Application.MessageButtons.OK_BUTTON [, (bool)enab…`
...
### `Application.View`
*bases: LomObject — This class represents the view aspects of the Live application.*
...
- `log((str)arg1) -> None`
- `subst_args((Text)text [, (str)arg1='' [, (str)arg2='' [, (str)arg3='' [, (str)arg4='' [, (str)arg5='']]]]]) -…`
...
### `Timer`
*A timer that will trigger a callback after a certain inverval. The timer can be repeated and will trigger the…*
...
### `Browser`
*bases: LomObject — This class represents the live browser data base.*
...
| `legacy_libraries` | R | Returns a list of browser items containing the installed legacy libraries. The list is always empty as legacy… |
...
### `CcControlDevice`
*bases: Device — This class represents a CcControl device.*
...
| `is_active` | R | Return const access to whether this device is active. This will be false bothwhen the device is off and when … |
| `is_using_compare_preset_b` | RW | Returns whether the Device has loaded the preset in compare slot B. Only relevant if can_compare_ab, otherwis… |
...
*bases: LomObject — Representing the view aspects of a device.*
...
### `Chain`
*bases: DeviceContainer — This class represents a group device chain in Live.*
...
### `ChainMixerDevice`
*bases: LomObject — This class represents a Chain's Mixer Device in Live, which gives you*
...
### `Clip`
*bases: LomObject — This class represents a Clip in Live. It can be either an Audio*
...
| `start_time` | R | Get the clip's start time offset. For Session View clips, this is the time the clip was started. For Arrangem… |
...
- `duplicate_notes_by_id((Clip)self, (object)note_ids [, (object)destination_time=None [, (int)transposition_amo…`
- `duplicate_region((Clip)self, (float)region_start, (float)region_length, (float)destination_time [, (int)pitch…`
- `fire((Clip)arg1) -> None`
...
- `get_notes_extended((Clip)arg1, (int)from_pitch, (int)pitch_span, (float)from_time, (float)time_span) -> MidiN…`
...
- `remove_notes_extended((Clip)arg1, (int)from_pitch, (int)pitch_span, (float)from_time, (float)time_span) -> No…`
...
### `Clip.View`
*bases: LomObject — Representing the view aspects of a Clip.*
...
### `ClipSlot`
*bases: LomObject — This class represents an entry in Lives Session view matrix.*
...
### `CompressorDevice`
*bases: Device — This class represents a Compressor device.*
...
### `Device`
*bases: LomObject — This class represents a MIDI or Audio DSP-Device in Live.*
...
### `DeviceIO`
*bases: LomObject — This class represents a specific input or output bus of a device.*
...
### `DeviceParameter`
*bases: LomObject — This class represents a (automatable) parameter within a MIDI or*
...
| `short_value_items` | R | Return the list of possible values for this parameter. Like value_items, but prefers short value names if ava… |
...
### `DriftDevice`
*bases: Device — This class represents a Drift device.*
...
### `DrumCellDevice`
*bases: Device — This class represents a DrumCell device.*
...
### `DrumChain`
*bases: Chain — This class represents a drum group device chain in Live.*
...
### `DrumPad`
*bases: LomObject — This class represents a drum group device pad in Live.*
...
### `Envelope`
*bases: LomObject — This class represents an automation or modulation envelope in Live.*
...
### `Eq8Device`
*bases: Device — This class represents an Eq8 device.*
...
### `Eq8Device.View`
*bases: View — Representing the view aspects of an Eq8 device.*
...
### `Groove`
*bases: LomObject — This class represents a groove in Live.*
...
### `GroovePool`
*bases: LomObject — This class represents the groove pool in Live.*
...
### `HybridReverbDevice`
*bases: Device — This class represents a Hybrid Reverb device.*
...
| `in_sassafras_mode` | R |  |
| `license_must_match_variant` | R | Returns a bool indicating if we require the license information returned by the server to match the variant o… |
| `random_number_for_trial_authorization` | R | Returns the integer to send along with the Trial authorization request. This same integer will be checked for… |
...
- `get_startup_dialog((PythonLicensingBridge)arg1, (object)authorize_callable, (object)authorize_later_callable)…`
...
- `end_modal_loop((StartupDialogServes as an entry point for the user to authorize Live on first launch.)arg1) -…`
- `run_in_modal_loop((StartupDialogServes as an entry point for the user to authorize Live on first launch.)arg1…`
- `set_notification_message((StartupDialogServes as an entry point for the user to authorize Live on first launc…`
...
### `LooperDevice`
*bases: Device — This class represents a Looper device.*
...
| `name` | RW | Return access to the name of the device. |
| `overdub_after_record` | RW | If true, Looper will switch to overdub after recording, when recording a fixed number of bars. Otherwise, the… |
| `parameters` | R | Const access to the list of available automatable parameters for this device. |
...
### `MaxDevice`
*bases: Device — This class represents a Max for Live device.*
...
### `MeldDevice`
*bases: Device — This class represents a Meld device.*
...
- `map_midi_cc((int)midi_map_handle, (DeviceParameter)parameter, (int)midi_channel, (int)controller_number, (Map…`
- `map_midi_cc_with_feedback_map((int)midi_map_handle, (DeviceParameter)parameter, (int)midi_channel, (int)contr…`
- `map_midi_note((int)arg1, (DeviceParameter)arg2, (int)arg3, (int)arg4) -> bool`
- `map_midi_note_with_feedback_map((int)arg1, (DeviceParameter)arg2, (int)arg3, (int)arg4, (NoteFeedbackRule)arg…`
...
### `MixerDevice`
*bases: LomObject — This class represents a Mixer Device in Live, which gives you*
...
### `PluginDevice`
*bases: Device — This class represents a plugin device.*
...
### `RackDevice`
*bases: Device — This class represents a Rack device.*
...
| `can_have_chains` | R | Returns true if the device is a rack. |
| `can_have_drum_pads` | R | Returns true if the device is a drum rack. |
| `can_show_chains` | R | return True, if this Rack contains a rack instrument device that is capable of showing its chains in session … |
| `canonical_parent` | R | Get the canonical parent of the Device. |
...
| `class_display_name` | R | Return const access to the name of the device's class name as displayed in Live's browser and device chain |
| `class_name` | R | Return const access to the name of the device's class. |
| `drum_pads` | R | Return const access to the list of drum pads in this device. Throws an exception if can_have_drum_pads is fal… |
| `has_drum_pads` | R | Returns true if the device is a drum rack which has drum pads. Throws an exception if can_have_drum_pads is f… |
...
| `name` | RW | Return access to the name of the device. |
| `parameters` | R | Const access to the list of available automatable parameters for this device. |
| `return_chains` | R | Return const access to the list of return chains in this device. Throws an exception if can_have_chains is fa… |
| `selected_variation_index` | RW | Access to the index of the currently selected macro variation.Throws an exception if the index is out of rang… |
| `type` | R | Return the type of the device. |
| `variation_count` | R | Access to the number of macro variations currently stored. |
| `view` | R | Representing the view aspects of a device. |
| `visible_drum_pads` | R | Return const access to the list of visible drum pads in this device. Throws an exception if can_have_drum_pad… |
...
### `RackDevice.View`
*bases: View — Representing the view aspects of a rack device.*
...
| `is_collapsed` | RW | Get/Set/Listen if the device is shown collapsed in the device chain. |
| `is_showing_chain_devices` | RW | Return whether the devices in the currently selected chain are visible. Throws an exception if can_have_chain… |
...
### `RoarDevice`
*bases: Device — This class represents a Roar device.*
...
### `Sample`
*bases: LomObject — This class represents a sample file loaded into a Simpler instance.*
...
### `Scene`
*bases: LomObject — This class represents an series of ClipSlots in Lives Sessionview matrix.*
...
### `ShifterDevice`
*bases: Device — This class represents a Shifter device.*
...
### `SimplerDevice`
*bases: Device — This class represents a Simpler device.*
...
### `SimplerDevice.View`
*bases: View — Representing the view aspects of a simpler device.*
...
| `sample_env_fade_in` | R | Access to the envelope fade-in time in samples. Returned value is only in use when Simpler is in one-shot mod… |
| `sample_env_fade_out` | R | Access to the envelope fade-out time in samples. Returned value is only in use when Simpler is in one-shot mo… |
...
### `CuePoint`
*bases: LomObject — Represents a 'Marker' in the arrangement.*
...
### `Song`
*bases: LomObject — This class represents a Live set.*
...
| `root_note` | RW | Set and access the root (i.e. key) of the song. The root can be a number between 0 and 11, with 0 correspondi… |
| `scale_intervals` | R | Reports the current scale's intervals as a list of integers, starting with the root and representing the numb… |
| `scale_mode` | RW | Access to the Scale Mode setting in Live. When on, key tracks that belong to the currently selected scale are… |
| `scale_name` | RW | Set and access the currently selected scale by name. The default scale names that can be saved with a set and… |
...
| `tempo_follower_enabled` | RW | Get/Set whether the Tempo Follower is controlling the tempo. The Tempo Follower Toggle must be made visible i… |
...
### `Song.View`
*bases: LomObject — Representing the view aspects of a Live document: The Session and Arrangerview.*
...
| `highlighted_clip_slot` | RW | Get/Set the clip slot, defined via the selected track and scene in the Session.Will be None for Main- and Sen… |
| `mod_mapping_device` | RW | The device that is waiting for a parameter (via mod_mapping_parameter) to modulate, or None if no device is w… |
...
*bases: Device — This class represents a Spectral Resonator device.*
...
### `TakeLane`
*bases: LomObject — This class represents a take lane in Live.*
...
### `DeviceContainer`
*bases: LomObject — This class is a common super class of Track and Chain*
...
### `Track`
*bases: DeviceContainer — This class represents a track in Live. It can be either an Audio*

| property | writable | doc |
|---|---|---|
| `_live_ptr` | R |  |
| `arm` | RW | Arm the track for recording. Not available for Main- and Send Tracks. |
| `arrangement_clips` | R | const access to the list of clips in arrangement viewThe list will be empty for the main, send and group trac… |
...
| `back_to_arranger` | RW | Indicates if it's possible to go back to playing back the clips in the Arranger.Setting a value 0 will go bac… |
...
| `can_show_chains` | R | return True, if this Track contains a rack instrument device that is capable of showing its chains in session… |
...
| `implicit_arm` | RW | Arm the track for recording. When The track is implicitly armed, it showsin a weaker color in the live GUI an… |
...
| `is_frozen` | R | return True if this Track is currently frozen. No changes should be applied to the track's devices or clips w… |
...
### `Track.View`
*bases: LomObject — Representing the view aspects of a Track.*

| property | writable | doc |
|---|---|---|
| `_live_ptr` | R |  |
| `canonical_parent` | R | Get the canonical parent of the track view. |
| `device_insert_mode` | RW | Get/Listen the device insertion mode of the track. By default, it will insert devices at the end, but it can … |
| `is_collapsed` | RW | Get/Set/Listen if the track is shown collapsed in the arranger view. |
| `selected_device` | R | Get/Set/Listen the insertion mode of the device. While in insertion mode, loading new devices from the browse… |
...
### `TuningSystem`
*bases: LomObject — Represents a Tuning System and its properties.*
...
| `note_tunings` | RW | Get/Set the currently active tuning system's note tunings, specified in Cents, where 100 Cents is one semi-to… |
...
### `WavetableDevice`
*bases: Device — This class represents a Wavetable device.*
